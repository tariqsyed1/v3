...
const About = () => {
    return (
        <div className="About">
            ...
            <div className='section'>These days you can find me working on <a link='https://advertising.amazon.com/en-ca/solutions/products/sponsored-display'>Sponsored Display</a>, building features to help advertisers maximize their advertising campaigns. I've had the privilege of working at a few different companies - If you’re curious, you can learn more about it <a link='/work'>here.</a></div>
            <div className='section'>When I’m not at my computer, I’m probably chilling with my <a>cat</a> or listening to <a>music</a>. If you'd like to chat, feel free to contact me via email or LinkedIn :)</div>
        </div>
    );
}; 
